...
| **Progress Reporting** | `generate_premium_report.py` | Generates a high-fidelity progress report from Notion, calculating **Done** and **Testing** percentages per feature. Categorizes into Completed and In-Staging sections. |
